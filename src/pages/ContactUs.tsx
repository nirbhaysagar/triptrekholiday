              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input type="tel" placeholder="+1 (555) 123-4567" className="bg-white" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Message
                  ...
                  <Button className="w-full bg-gray-900 text-white hover:bg-gray-800 py-6 text-base">
                    Send Message
                  </Button>
                </form>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@triptrekholiday.com</p>
                      <p className="text-gray-600">support@triptrekholiday.com</p>
                    </div>
                  </div>
