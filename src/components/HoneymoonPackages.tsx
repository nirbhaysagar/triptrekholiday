            ...
            >
              {honeymoonDestinations.map((destination) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="bg-white rounded-[22px] overflow-hidden border border-pink-200 hover:border-pink-300 hover:shadow-lg transition-all duration-1000 ease-out group cursor-pointer h-[368px]"
                    ...
                    >
                      <div className="relative h-full">
                        ...
                        {/* Hover overlay */}
                        <div className={`absolute inset-0 bg-gradient-to-br from-pink-600/40 to-rose-600/40 flex items-center justify-center transition-opacity duration-1000 ease-out ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
